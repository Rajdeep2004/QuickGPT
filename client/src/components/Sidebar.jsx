...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    // <div
    //   className={`flex flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b  from-[#242124]/30 to-[#000000]/30 border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 max-md:absolute top-0 left-0 z-10
  ...
  fixed top-0 left-0 z-50 md:static md:translate-x-0
